...
function BreadcrumbDirective($interpolate, $breadcrumb, $rootScope) {
    var $$templates = {
        bootstrap2: '<ul class="breadcrumb">' +
            ...
            '<a ng-switch-when="false" href="{{step.ncyBreadcrumbLink}}" title="{{step.ncyBreadcrumbLabel}}">{{step.ncyBreadcrumbLabel}}</a>' +
            '<span ng-switch-when="true" title="{{step.ncyBreadcrumbLabel}}">{{step.ncyBreadcrumbLabel}}</span>' +
