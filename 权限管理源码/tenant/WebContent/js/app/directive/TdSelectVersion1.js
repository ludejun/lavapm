define(['app','angularAMD','app/filter/DateStrSubstringmin10','app/filter/platformFilter'], function (app,angularAMD) {
    'use strict';
    angularAMD.directive('tdSelectVersion1',['$rootScope','ConditionService','$state','$timeout', 
    	...
    	return {
    		...
    		templateUrl : "js/app/directive/template/td-select-version1.html",
...
//	            	ngModel.$setViewValue(key);
	    		...
	    		$scope.onBodyDown = function(event) {
	    			...
	    			if (!("opt in options" == $target.attr("ng-repeat")
