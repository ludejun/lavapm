		...
		if(sessionId!=null&&sessionId.trim().length()==36){
			...
			try{
				...
				if(user!=null){
					...
					script.append("form.username.value = \"").append(user.getLoginName()).append("\";\n");
					script.append("form.password.value = \"").append(sessionId).append("\";\n");
					script.append("form.submit.click();\n");		
